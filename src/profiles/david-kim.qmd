...
image: /public/uploads/Rauz_green_barbarian.png
email: david.kim@liia.edu.br
bio: David focuses on applying graph-based machine learning to biological
  networks. His work involves developing new algorithms for protein-protein
  interaction prediction and metabolic pathway analysis.
researchInterests:
  - Biological Networks
